    ...
    $scope.getPros = function () {
        Lottery.getPros($scope.gid, function (c) {
            ...
            angular.forEach($scope.playlist.play, function (d) {
                if (d.sname == 'zh') {
                    $scope.p1 = d.play.slice(0, 5)
                    $scope.p2 = d.play.slice(5, 10)
                    $scope.p3.push(d.play[10], d.play[10], d.play[10], d.play[11], d.play[11])
                } else {
                    $scope.p4 = d.play
                }
            })
